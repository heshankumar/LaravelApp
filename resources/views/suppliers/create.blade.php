                        ...
                        <div class="p-6 md:grid md:grid-cols-2 md:gap-6  ">
                                ...
                                <div class="p-6" >
                                    <form method="POST" action="{{route('supplier.store')}}">
                                        ...
                                        @method('post')
                                        <div class="mb-5">
                                            <label class="mb-3 block text-base font-medium text-gray-900 dark:text-gray-400">Supplier Name</label>
                                            <input class="w-full p-2 border rounded-md" type="text" name="supplier_name" placeholder="Name" >
                                        </div>
                                        <div class="mb-5">
                                            <label class="mb-3 block text-base font-medium text-gray-900 dark:text-gray-400">Address</label>
                                            <input class="w-full p-2 border rounded-md" type="text" name="address" placeholder="Address" >
                                        </div>
                                        <div class="mb-5">
                                            <label class="mb-3 block text-base font-medium text-gray-900 dark:text-gray-400">Email</label>
                                            <input class="w-full p-2 border rounded-md" type="text" name="email" placeholder="Email" >
                                        </div>
                                        <div class="mb-5">
                                            <label class="mb-3 block text-base font-medium text-gray-900 dark:text-gray-400">Telephone</label>
                                            <input class="w-full p-2 border rounded-md" type="text" name="telephone" placeholder="Telephone" >
                                        </div>
                                        <div class="mb-5">
                                            <label class="mb-3 block text-base font-medium text-gray-900 dark:text-gray-400">Contact Person</label>
                                            <input class="w-full p-2 border rounded-md" type="text" name="contact_person" placeholder="Contact Person" >
                                        </div>
                                        <div class="mb-5">
