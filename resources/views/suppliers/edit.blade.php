                                ...
                                <div class="p-6" align="left">
                                    <form method="POST" action="{{route('supplier.update', ['supplier'=>$supplier])}}">
                                        ...
                                        <div class="mb-5">
                                            ...
                                            <input class="w-full p-2 border rounded-md" type="text" name="supplier_name" placeholder="Name" value="{{$supplier->supplier_name}}">
                                        </div>
                                        <div class="mb-5">
                                            <label class="mb-3 block text-base font-medium text-gray-900 dark:text-gray-400">Address</label>
                                            <input class="w-full p-2 border rounded-md" type="text" name="address" placeholder="Address" value="{{$supplier->address}}">
                                        </div>
                                        <div class="mb-5">
                                            <label class="mb-3 block text-base font-medium text-gray-900 dark:text-gray-400">Email</label>
                                            <input class="w-full p-2 border rounded-md" type="text" name="email" placeholder="Email" value="{{$supplier->email}}">
                                        </div>
                                        <div class="mb-5">
                                            <label class="mb-3 block text-base font-medium text-gray-900 dark:text-gray-400">Telephone</label>
                                            <input class="w-full p-2 border rounded-md" type="text" name="telephone" placeholder="Telephone" value="{{$supplier->telephone}}">
                                        </div>
                                        <div class="mb-5">
                                            <label class="mb-3 block text-base font-medium text-gray-900 dark:text-gray-400">Contact Person</label>
                                            <input class="w-full p-2 border rounded-md" type="text" name="contact_person" placeholder="Contact Person" value="{{$supplier->contact_person}}">
                                        </div>
                                        <div class="mb-5">
