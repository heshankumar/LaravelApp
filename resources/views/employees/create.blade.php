                                ...
                                <div class="p-6" >
                                    <form method="POST" action="{{route('employee.store')}}">
                                        ...
                                        <div class="mb-5">
                                            ...
                                            <input class="w-full p-2 border rounded-md" type="text" name="nic" placeholder="ex: 961981700v" >
                                        </div>
                                        <div class="mb-5">
                                            <label class="mb-3 block text-base font-medium text-gray-900 dark:text-gray-400">Employee Name</label>
                                            <input class="w-full p-2 border rounded-md" type="text" name="empl_name" placeholder="ex: Heshan de Silva" >
                                        </div>
                                        <div class="mb-5">
                                            <label class="mb-3 block text-base font-medium text-gray-900 dark:text-gray-400">Position</label>
                                            <input class="w-full p-2 border rounded-md" type="text" name="position" placeholder="ex: Salesman" >
                                        </div>
                                        <div class="mb-5">
                                            <label class="mb-3 block text-base font-medium text-gray-900 dark:text-gray-400">Joined Date</label>
                                            <input class="w-full p-2 border rounded-md" type="date" name="joined_date" placeholder="Joined Date" >
                                        </div>
                                        <div class="mb-5">
